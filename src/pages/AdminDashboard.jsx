...
export default function AdminDashboard({ setCurrentPage }) {
  ...
  const stats = [
    ...
    { label: "Active Users", value: "342", change: "+8.2%", isPositive: true, icon: <UserIcon />, colorClass: "bg-orange-100" },
    { label: "Pending Reviews", value: "23", change: "-5.1%", isPositive: false, icon: <AlertIcon />, colorClass: "bg-orange-100" },
  ]

  const incidentReports = [
    { rId: "R-1024", type: "Illegal Dumping", subId: "RPT-2024-001", submittedBy: "John Doe", location: "Sector 4, Corner Ave", date: "2024-05-15", status: "Pending", iconType: "alert" },
    { rId: "R-1025", type: "Overflowing Bin", subId: "RPT-2024-002", submittedBy: "Sarah Smith", location: "Central Park Main Gate", date: "2024-05-14", status: "In Progress", iconType: "bin" },
    { rId: "R-1026", type: "Missed Collection", subId: "RPT-2024-003", submittedBy: "Mike Johnson", location: "123 Pine St", date: "2024-05-14", status: "Resolved", iconType: "bin" },
    { rId: "R-1027", type: "Hazardous Waste", subId: "RPT-2024-004", submittedBy: "Emily Brown", location: "Industrial Zone B", date: "2024-05-13", status: "Pending", iconType: "alert" },
  ];
  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-header">
        <h2>Dashboard</h2>
        <p>Welcome back! Here's your environmental tracking overview for Barangay Upper Sibatang, Pagadian City.</p>
      </div>
      ...
      <div className="section-container full-width">
        <div className="section-header-row">
          <h3 className="section-title">Recent Incidents & Reports</h3>
        ...
        <div className="incidents-table-container">
          ...
          {incidentReports.map((item, idx) => (
            <div key={idx} className="table-row">
              <div className="td-cell text-id">{item.rId}</div>
              <div className="td-cell type-cell">
                <div className={`icon-box ${item.iconType === 'alert' ? 'bg-red-light' : 'bg-gray-light'}`}>
                  {item.iconType === 'alert' ? <AlertIcon /> : <TrashIcon />}
                </div>
                <div className="report-details">
                  <span className="report-name">{item.type}</span>
                  <span className="report-subid">ID: {item.subId}</span>
                </div>
              </div>
              <div className="td-cell text-user">{item.submittedBy}</div>
              <div className="td-cell text-gray">{item.location}</div>
              <div className="td-cell text-gray">{item.date}</div>
